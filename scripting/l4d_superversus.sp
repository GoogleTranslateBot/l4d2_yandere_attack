...
public void OnPluginStart()
{
	...
	AutoJoin = CreateConVar("l4d_autojoin", "2" , "Once a player connects, 4: Put in infected team, 3: Put in survivor team, 2: Put in random team, 1: Show teammenu, 0: Do nothing", CVAR_FLAGS, true, 0.0, true, 4.0);
